...
import { adminQuizCreate, adminQuizDescriptionUpdate, adminQuizRemove, adminQuizNameUpdate, adminQuizList, adminQuizInfo, adminQuizTrash, adminQuizQuestionCreate, adminQuizRestore,adminQuizQuestionMove } from './quiz';
