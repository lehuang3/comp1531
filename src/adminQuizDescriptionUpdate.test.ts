...
describe('v1 routes', () => {
  ...
  test('Check for invalid quiz', () => {
    const response = v1requestAdminQuizDescriptionUpdate(token1, quiz1 + 1, 'this quiz now has description');
    expect(response.body).toStrictEqual({
  ...
  test('Check for ownership', () => {
    ...
    const response = v1requestAdminQuizDescriptionUpdate(token2, quiz1, 'this quiz now has description');
    expect(response.body).toStrictEqual({
  ...
  describe('Check for valid quiz', () => {
    ...
    test('Check for valid quiz - empty description', () => {
      const response = v1requestAdminQuizDescriptionUpdate(token1, quiz1, '');
      expect(response.body).toStrictEqual({});
      expect(response.status).toStrictEqual(200);
    });
  });
